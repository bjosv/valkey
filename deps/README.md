...
* **libvalkey** is the official C client library for Valkey. It is used by valkey-cli, valkey-benchmark and Sentinel. It is managed in a separate project and updated as needed.
